# Getting help with distionary

Thanks for using distionary! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/vincenzocoia/distionary/issues/new).
...
requests](https://github.com/vincenzocoia/distionary/issues) to make
